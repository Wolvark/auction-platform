package com.auction.platform.configuration;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                // JWT Bearer tokens (not cookies) for authentication. CSRF attacks require
                // credentials to be automatically sent by the browser (e.g., via cookies),
